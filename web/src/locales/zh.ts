...
General：实体和关系提取提示来自 GitHub - microsoft/graphrag：基于图的模块化检索增强生成 (RAG) 系统`,
    ...
    chat: {
      ...
      system: '系统提示词',
      systemInitialValue: `你是一个智能助手。请根据当前情况回答问题：
...
请始终考虑聊天历史，保持回答准确且友好。`,
      ...
      // Bot Management
      botManagement: 'Bot管理',
      botManagementDescription: '创建和管理你的聊天机器人',
      selectBotToViewSessions: '在上方选择Bot以查看FreeChat会话',
      noBotsYet: '还没有创建Bot',
      createFirstBot: '创建你的第一个Bot',
      editBot: '编辑Bot',
      deleteBot: '删除Bot',
      ...
      selectBotPrompt: '选择Bot以查看会话',
      noSessionsYet: '还没有聊天会话',
      createFirstChat: '创建第一个会话',
      untitledChat: '未命名会话',
      updated: '更新时间',
      unknownUser: '未知用户',
      // Free Chat
    ...
    fileManager: {
      ...
      uploadAllFiles: '上传全部文件',
      uploadFolderSuccess: '成功上传 {files} 个文件到 {folders} 个文件夹',
      uploadFailed: '上传失败',
      createKBFromFolder: '从文件夹创建知识库：{name}',
      kbName: '知识库名称',
      kbNamePlaceholder: '请输入知识库名称',
      description: '描述',
      descriptionPlaceholder: '请输入描述（可选）',
      parserType: '解析器类型',
      createKBSuccess: '成功创建知识库，包含 {count} 个文档',
